...
import com.nic.ODF_Thittam.Fragment.SlideshowDialogFragment;
import com.nic.ODF_Thittam.R;
import com.nic.ODF_Thittam.adapter.FullImageAdapter;
...
import com.nic.ODF_Thittam.databinding.FullImageRecyclerBinding;
...
public class FullImageActivity extends AppCompatActivity implements View.OnClickListener, Api.ServerResponseListener {
    ...
    private static  ArrayList<ODF_Thittam> activityImage = new ArrayList<>();
    ...
    public class fetchImagetask extends AsyncTask<Void, Void,
        ...
        @Override
        protected void onPostExecute(final ArrayList<ODF_Thittam> imageList) {
    ...
    public void generateImageArrayList(JSONArray jsonArray){
        if(jsonArray.length() > 0){
            ...
            for(int i = 0; i < jsonArray.length(); i++ ) {
                try {
                    ODF_Thittam imageOnline = new ODF_Thittam();
