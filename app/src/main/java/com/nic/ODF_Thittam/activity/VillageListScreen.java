...
import com.nic.ODF_Thittam.adapter.VillageListAdapter;
import com.nic.ODF_Thittam.dataBase.dbData;
import com.nic.ODF_Thittam.databinding.VillageListActivityBinding;
...
public class VillageListScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    public class fetchScheduletask extends AsyncTask<Void, Void,
        ...
        protected ArrayList<ODF_Thittam> doInBackground(Void... params) {
            dbData.open();
            ArrayList<ODF_Thittam> villageList = new ArrayList<>();
        ...
        @Override
        protected void onPostExecute(ArrayList<ODF_Thittam> villageList) {
