...
import com.nic.ODF_Thittam.databinding.AdapterAdditionalListBinding;
...
public class AdditionalListAdapter extends PagedListAdapter<ODF_Thittam, AdditionalListAdapter.MyViewHolder> implements Filterable {
    private List<ODF_Thittam> AdditionalListValues;
    private List<ODF_Thittam> AdditionalListValuesFiltered;
    ...
    public AdditionalListAdapter(Context context, List<ODF_Thittam> WorkListValues,dbData dbData) {
        super(DIFF_CALLBACK);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (ODF_Thittam row : AdditionalListValues) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                AdditionalListValuesFiltered = (ArrayList<ODF_Thittam>) filterResults.values;
