...
import com.nic.ODF_Thittam.databinding.GalleryThumbnailBinding;
...
public class FullImageAdapter extends RecyclerView.Adapter<FullImageAdapter.MyViewHolder> {
    ...
    private List<ODF_Thittam> imagePreviewlistvalues;
    private final dbData dbData;
    private LayoutInflater layoutInflater;

    public FullImageAdapter(Context context, List<ODF_Thittam> imagePreviewlistvalues, dbData dbData) {
